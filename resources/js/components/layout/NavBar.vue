          ...
          <div class="flex-shrink-0 flex items-center">
            <div class="flex-shrink-0 flex items-center">
              <img class="inline h-10 w-auto"
                   src="http://tailwindui.test/images/logo_ffh_noir_sans_ff.png" alt="FFH">
            </div>
          </div>
          ...
          <Menu as="div" class="ml-4 relative flex-shrink-0">
            ...
            <transition enter-active-class="transition ease-out duration-100"
              ...
              <MenuItems
                ...
                <MenuItem v-slot="{ active }">
                  <a href="#"
                     :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700']">Paramètres</a>
                </MenuItem>
                <MenuItem v-slot="{ active }">
    ...
    <DisclosurePanel class="lg:hidden">
      ...
      <div class="pt-4 pb-3 border-t border-gray-200">
        <div class="flex items-center px-4">
          ...
          <div class="ml-3">
            <div class="text-base font-medium text-gray-800">Matthieu Labaune</div>
            <div class="text-sm font-medium text-gray-500">m.labaune@handisport.org</div>
          </div>
          <button type="button"
